...
#    now_SP = elf.get_Gryzinski_SP_single(now_E, EB[0], mc.n_Si, mc.n_val_Si, mc.WW_ext)
    now_SP = gryz.get_Gr_S(EB[0], now_E, mc.n_Si, mc.n_val_Si)
...
#        now_SP = elf.get_Gryzinski_SP_single(now_E, eb, mc.n_Si, mc.n_val_Si, mc.WW_ext)
        now_SP = gryz.get_Gr_S(eb, now_E, mc.n_Si, mc.n_val_Si)
...
#%%
plt.semilogx(EE, E_BIND, '--', label='adjusted E$_{bind}$')
...
plt.savefig('E_bind_val_Si_2021.png', dpi=300)
