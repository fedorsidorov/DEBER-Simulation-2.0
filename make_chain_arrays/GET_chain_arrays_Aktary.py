...
#%%
source_dir = mv.sim_path_MAC + 'CHAINS/Aktary_950K_100nm/comb_100x100x100_center/'
...
np.save('MATRIX_resist_Aktary.npy', resist_matrix)

#%%
print('chain_table size, Gb:', chain_table.nbytes / 1024**3)
np.save('TABLE_chains_Aktary.npy', chain_table)

#%%
resist_matrix = np.load('MATRIX_resist_Aktary.npy')
chain_table = np.load('TABLE_chains_Aktary.npy')
