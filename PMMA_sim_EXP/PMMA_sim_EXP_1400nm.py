...
dest_dir = '/Volumes/ELEMENTS/Chains_EXP_1400nm/'
...
#%%
n_empty = 700*5*450 - np.count_nonzero(hist_2nm)
part_empty = n_empty / (700*5*450)
...
plt.savefig('EXP_sample_period_1400nm.png', dpi=300)
