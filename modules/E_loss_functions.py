...
def get_Si_Gryzinski_3S_diff_U(EE):
    return get_Gryzinski_diff_CS(EE, mc.binding_Si[3]) * mc.occupancy_Si[3] * mc.n_Si


def get_Si_Gryzinski_3P_diff_U(EE):
    return get_Gryzinski_diff_CS(EE, mc.binding_Si[4]) * mc.occupancy_Si[4] * mc.n_Si
...
def get_Si_Gryzinski_3S_int_U(EE):
    return mu.diff2int(get_Si_Gryzinski_3S_diff_U(EE))


def get_Si_Gryzinski_3P_int_U(EE):
    return mu.diff2int(get_Si_Gryzinski_3P_diff_U(EE))
...
def get_Si_Gryzinski_3S_U(EE):
    return get_Gryzinski_CS(EE, mc.binding_Si[3]) * mc.occupancy_Si[3] * mc.n_Si


def get_Si_Gryzinski_3P_U(EE):
    return get_Gryzinski_CS(EE, mc.binding_Si[4]) * mc.occupancy_Si[4] * mc.n_Si
...
def get_Si_Gryzinski_core_U(EE):
    ...
    CS_Si_1S = get_Gryzinski_CS(EE, mc.binding_Si[0]) * mc.occupancy_Si[0]
    U_Si_K = CS_Si_1S * mc.n_Si
    
    CS_Si_2S = get_Gryzinski_CS(EE, mc.binding_Si[1]) * mc.occupancy_Si[1]
    CS_Si_2P = get_Gryzinski_CS(EE, mc.binding_Si[2]) * mc.occupancy_Si[2]
...
def get_Si_Gryzinski_core_SP(EE):
    ...
    SP_Si_1S = get_Gryzinski_SP(EE, mc.binding_Si[0], mc.n_Si, mc.occupancy_Si[0])
    SP_Si_2S = get_Gryzinski_SP(EE, mc.binding_Si[1], mc.n_Si, mc.occupancy_Si[1])
    SP_Si_2P = get_Gryzinski_SP(EE, mc.binding_Si[2], mc.n_Si, mc.occupancy_Si[2])
...
def get_Si_Gryzinski_total_SP(EE):
    ...
    SP_Si_2S = get_Gryzinski_SP(EE, mc.binding_Si[1], mc.n_Si, mc.occupancy_Si[1])
    SP_Si_2P = get_Gryzinski_SP(EE, mc.binding_Si[2], mc.n_Si, mc.occupancy_Si[2])
    SP_Si_3S = get_Gryzinski_SP(EE, mc.binding_Si[3], mc.n_Si, mc.occupancy_Si[3])
    SP_Si_3P = get_Gryzinski_SP(EE, mc.binding_Si[2], mc.n_Si, mc.occupancy_Si[2])
