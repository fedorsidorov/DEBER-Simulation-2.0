...
#                    break
    ...
    dirname = '../CHAINS/Greeneich_300nm/raw/'
...
#%%
chain_arr = np.load(mv.sim_path_MAC + 'CHAINS/Greeneich_300nm/raw/chain_0.npy')
...
#%%
x, y, z = chain_coords[:, 0], chain_coords[:, 1], chain_coords[:, 2]
