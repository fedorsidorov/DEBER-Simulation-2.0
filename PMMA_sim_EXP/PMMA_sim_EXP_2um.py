...
dest_dir = '/Volumes/ELEMENTS/Chains_EXP_2um_NEW2/'
...
#%%
n_empty = 1000*5*450 - np.count_nonzero(hist_2nm)
part_empty = n_empty / (1000*5*450)
...
plt.plot(xx, yy*6.5e+3, label='Schulz-Zimm')
...
plt.savefig('EXP_sample_period_2um_NEW2.png', dpi=300)
