...
#%%
e_matrix = np.load(mc.sim_folder + 'e-matrix_EXP/EXP_2um_160C/EXP_e_matrix_val_MY_dose' +\
                   str(n_dose) + '.npy')
...
#%%
np.save('2um_CT_160C_zip3000/full_mat_dose'+ str(n_dose) +'.npy', full_mat)
np.save('2um_CT_160C_zip3000/mono_mat_dose'+ str(n_dose) +'.npy', mono_mat)
