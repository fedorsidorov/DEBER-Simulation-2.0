...
#%%
source_dir = mv.sim_path_MAC + 'CHAINS/950K_100nm???/'
dest_dir = mv.sim_path_MAC + 'CHAINS/Greeneich_300nm/comb_100x100x300_center/'
...
for i in range(N_chains):
    ...
    lens.append(len(now_chain))
    
lens_arr = np.array(lens)
lens_log_arr = np.log10(lens_arr)
...
#    np.save(dest_dir + 'chain_shift_' + str(i) + '_10nm.npy', chain)
    i += 1
