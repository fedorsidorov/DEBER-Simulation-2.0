...
#%%
#l_xyz = np.array((400, 10, 900))
#l_xyz = np.array((800, 10, 900))
#l_xyz = np.array((1000, 10, 900))
l_xyz = np.array((1200, 10, 900))
#l_xyz = np.array((1400, 10, 900))
...
folders = ['e_DATA_EXP_E_bind_4p94_inel_MAC', 'e_DATA_EXP_E_bind_4p94_inel_FTIAN']
...
while n_electrons < n_electrons_required:
    ...
    n_electrons += 10 * n_files


#%%
np.save('EXP_1200nm/EXP_e_matrix_val_MY_dose3.npy', e_matrix_val_my)
np.save('EXP_1200nm/EXP_e_matrix_dE_MY_dose3.npy', e_matrix_dE)
