...
#%%
e_matrix = np.load(mc.sim_folder +\
    'e-matrix_EXP/EXP_2um_160C_reducing_FIT_FINAL/EXP_e_matrix_val_MY_dose'\
    + str(n_dose) + '.npy')
        ...
        while now_zipped < zip_len:
            ...
            if n_next_mon >= 0 and n_next_mon < now_len-1:
                ...
                while len(now_monomer_positions) == 0:
                    ...
                    if cnt > 100:
                        unzip_lens[pos] += zip_len - now_zipped
...
#%%
np.save('2um_CT_160C_reducing_3400/full_mat_dose'+ str(n_dose) +'.npy', full_mat)
np.save('2um_CT_160C_reducing_3400/mono_mat_dose'+ str(n_dose) +'.npy', mono_mat)
