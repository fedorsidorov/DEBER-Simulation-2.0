...
#%%
e_matrix = np.load(mc.sim_folder + 'e-matrix_EXP/EXP_2um_ester/EXP_e_matrix_val_MY_dose1.npy')
...
#%%
np.save('2um_CT_ester/full_mat_dose1.npy', full_mat)
np.save('2um_CT_ester/mono_mat_dose1.npy', mono_mat)
